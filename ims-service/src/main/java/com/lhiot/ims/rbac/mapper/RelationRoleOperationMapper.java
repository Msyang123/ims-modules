...
public interface RelationRoleOperationMapper {
    ...
    */
    int create(RelationRoleOperation relationRoleOperation);
    ...
    * @date 2018/09/29 11:42:57
    */
    int updateById(RelationRoleOperation relationRoleOperation);
    ...
    * @date 2018/09/29 11:42:57
    */
    RelationRoleOperation selectById(Long id);
    ...
    * @date 2018/09/29 11:42:57
    */
     List<RelationRoleOperation> pageRelationRoleOperations(RelationRoleOperation relationRoleOperation);
    ...
    * @date 2018/09/29 11:42:57
    */
    long pageRelationRoleOperationCounts(RelationRoleOperation relationRoleOperation);
}
