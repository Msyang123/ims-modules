...
public interface RelationUserRoleMapper {
    ...
    */
    int create(RelationUserRole relationUserRole);
    ...
    * @date 2018/09/29 11:42:57
    */
    int updateById(RelationUserRole relationUserRole);
    ...
    * @date 2018/09/29 11:42:57
    */
    RelationUserRole selectById(Long id);
    ...
    * @date 2018/09/29 11:42:57
    */
     List<RelationUserRole> pageRelationUserRoles(RelationUserRole relationUserRole);
    ...
    * @date 2018/09/29 11:42:57
    */
    long pageRelationUserRoleCounts(RelationUserRole relationUserRole);
}
